...
export interface ApiAichatAichat extends Struct.CollectionTypeSchema {
  collectionName: 'ai_chats';
  info: {
    description: 'AI Chat streaming endpoint (no data storage, custom routes only)';
    displayName: 'AI Chat';
    pluralName: 'aichats';
    singularName: 'aichat';
  };
...
export interface ApiEpaperEpaper extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Daily newspaper PDF editions';
    displayName: 'EPaper';
    pluralName: 'epapers';
    singularName: 'epaper';
  };
  ...
  attributes: {
    ...
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Edici\u00F3n del d\u00EDa'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiVideoPostVideoPost extends Struct.CollectionTypeSchema {
  collectionName: 'video_posts';
  info: {
    description: 'Video content for the Videos del D\u00EDa feed';
    displayName: 'Video Post';
    pluralName: 'video-posts';
    singularName: 'video-post';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    posted_comments: Schema.Attribute.Relation<
      'oneToMany',
      'api::comment.comment'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::aichat.aichat': ApiAichatAichat;
