                ...
                {!isLoading && !error && (
                    <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        {articles.map((article) => (
                            <div key={article.id} className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden shadow-lg hover:border-zinc-700 transition-all">
                                {article.coverImage && (
                                    <img
                                ...
                                <div className="p-4">
                                    ...
                                    <p className="text-zinc-400 text-sm line-clamp-3">{article.dek}</p>
